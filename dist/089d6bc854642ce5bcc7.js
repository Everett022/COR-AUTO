        ...
        case 0:
          ...
          return Excel.run(/*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(context) {
              var inventoryReportWorksheet, inventoryUsedRange, dynamicWorksheet, dynamicUsedRange, openPOsWorksheet, openPOsUsedRange, inventoryWorksheet, dynamicHeaders, dynItemCodeIdx, dynItemQtyIdx, dynItemCodeColumn, dynItemQtyColumn, openPOsHeaders, openPOItemCodeIdx, openPOItemQtyIdx, openPOItemCodeColumn, openPOItemQtyColumn, inventoryHeaders, invItemCodeIdx, invItemQtyIdx, invLocationIdx, invRepItemCodeColumn, invRepItemQtyColumn, invRepLocationColumn, dynamic, dynamicQR, dynamicICR, inventoryICR, inventoryQR, inventoryLOC, openPOs, openPOsICR, openPOsQR, invFilterICR, invFilterQR, initialEntry, result, _iterator7, _step7, _code7, demandQty, caseNumbers, requiredAmounts, mebArray, i, location, invCode, code, qty, mebSumMap;
              return _regenerator().w(function (_context8) {
                while (1) switch (_context8.n) {
                  ...
                  case 1:
                    ...
                    invRepLocationColumn = "".concat(colIdxToLetter(invLocationIdx), ":").concat(colIdxToLetter(invLocationIdx)); //Quanity and Item Code from Dynamic, Inventory Report, and Open PO's sheets
                    dynamic = context.workbook.worksheets.getItem("Dynamic");
                    dynamicQR = dynamic.getRange(dynItemQtyColumn).getUsedRange().load("values");
                    dynamicICR = dynamic.getRange(dynItemCodeColumn).getUsedRange().load("values");
                    _context8.n = 2;
                  ...
                  case 3:
                    ...
                    for (i = 0; i < caseNumbers.length; i++) {
                      location = String(inventoryLOC.values[i][0]).trim();
                      invCode = String(inventoryICR.values[i][0]).trim();
                      code = String(caseNumbers[i]).trim();
                      qty = Number(inventoryQR.values[i][0]);
...
function _resetAll() {
  _resetAll = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        ...
        case 0:
          ...
          return Excel.run(/*#__PURE__*/function () {
            var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14(context) {
              var startDateInput, endDateInput, startDate, endDate, dynamicWorksheet, dynamicUsedRange, dynamicHeaders, dynItemCodeIdx, dynStartIdx, dynItemQtyIdx, dynJobIdx, dynStartColumn, dynItemQtyColumn, dynItemCodeColumn, dynJobColumn, dynamic, dynamicICR, dynamicQR, plannedStart, jobNumber, jobLatestMap, i, itemCode, dateStr, date, job, qty, _iterator8, _step8, entry, _itemCode2, _date2, _i3, _itemCode, _dateStr, _date, _job, _qty;
              return _regenerator().w(function (_context14) {
                while (1) switch (_context14.n) {
                  ...
                  case 2:
                    ...
                    earlyDateMap.clear();
                    _iterator8 = _createForOfIteratorHelper(filter);
                    try {
                    ...
                    return context.sync();
                  case 3:
                    for (_i3 = 1; _i3 < dynamicICR.values.length; _i3++) {
                      _itemCode = String(dynamicICR.values[_i3][0]).trim();
                      _dateStr = plannedStart.values[_i3] ? String(plannedStart.values[_i3][0]).trim() : "";
                      _date = ExcelDateToJSDate(_dateStr);
                      _date.setHours(0, 0, 0, 0);
                      _job = String(jobNumber.values[_i3][0]).trim();
                      _qty = Number(dynamicQR.values[_i3][0]);
                      if (_itemCode) {
                        allData.push({
                          itemCode: _itemCode,
                          qty: _qty,
              ...
              return _regenerator().w(function (_context16) {
                while (1) switch (_context16.n) {
                  ...
                  case 2:
                    ...
                    earlyDateMap.clear();
                    _iterator9 = _createForOfIteratorHelper(invFilter);
                    try {
                      for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
                        entry = _step9.value;
                        _itemCode3 = entry.itemCode, _date3 = entry.date;
                        if (!earlyDateMap.has(_itemCode3) || _date3 < earlyDateMap.get(_itemCode3)) {
                          earlyDateMap.set(_itemCode3, _date3);
                        }
                      }
                    } catch (err) {
                      _iterator9.e(err);
              ...
              return _regenerator().w(function (_context21) {
                while (1) switch (_context21.n) {
                  case 0:
                    ...
                    _context21.n = _t2 === "Intial" ? 1 : _t2 === "over-300" ? 2 : _t2 === "Must-buy" ? 3 : _t2 === "Can-buy" ? 4 : _t2 === "Can-make" ? 5 : 6;
                    break;
                  case 1:
